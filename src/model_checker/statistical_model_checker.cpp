    ...
    : _settings(settings)
{
    ...
    STORM_LOG_THROW(model_and_properties.property.size() == 1, storm::exceptions::UnexpectedException,
                    "Only one property is expected.");
...
{
    STORM_LOG_THROW(_result->isExplicitQuantitativeCheckResult(), storm::exceptions::UnexpectedException,
...
{
    STORM_LOG_THROW(_result->isExplicitQualitativeCheckResult(), storm::exceptions::UnexpectedException,
